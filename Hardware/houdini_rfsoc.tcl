...
#
# houdini_rfsoc.tcl: Tcl script for re-creating project 'houdini_rfsoc'
#
# Generated by Vivado on Fri Aug 08 13:10:53 CDT 2025
...
#
# 1. This project restoration tcl script (houdini_rfsoc.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/space/vivado/houdini_rfsoc/houdini_rfsoc.srcs/utils_1/imports/synth_1/houdini_rfsoc_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../space/vivado/houdini_rfsoc/houdini_rfsoc.srcs/utils_1/imports/synth_1/houdini_rfsoc_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "houdini_rfsoc"
...
set script_file "houdini_rfsoc.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../space/vivado/houdini_rfsoc"]"
...
set_msg_config  -id {Board 49-91}  -string {{WARNING: [Board 49-91] Board repository path '~/petalinux_working/RFSoC4x2-BSP/board_files' does not exist, it will not be used to search board files.}}  -suppress  -ruleid {1}  -source 8


# Set project properties!!!!IMPORTANT Change the board repo path to your own location!!!
set obj [current_project]
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/petalinux_working/RFSoC4x2-BSP/board_files/rfsoc4x2/1.0"]" -objects $obj
...
set_property -name "top" -value "houdini_rfsoc_wrapper" -objects $obj
...
set file "synth_1/houdini_rfsoc_wrapper.dcp"
...
# Proc to create BD houdini_rfsoc
proc cr_bd_houdini_rfsoc { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name houdini_rfsoc
...
\
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports rgbled0] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports rgbled1] [get_bd_intf_pins axi_gpio_1/GPIO2]
  ...
  connect_bd_net -net axi_gpio_2_ip2intc_irpt [get_bd_pins axi_gpio_2/ip2intc_irpt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN]
...
# End of cr_bd_houdini_rfsoc()

cr_bd_houdini_rfsoc ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files houdini_rfsoc.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files houdini_rfsoc.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list houdini_rfsoc.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../space/vivado/houdini_rfsoc/houdini_rfsoc.gen/sources_1/bd/houdini_rfsoc/hdl/houdini_rfsoc_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list houdini_rfsoc.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/houdini_rfsoc_wrapper.dcp" -objects $obj
